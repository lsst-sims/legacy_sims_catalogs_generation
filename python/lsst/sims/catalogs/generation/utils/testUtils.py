...
from lsst.sims.catalogs.generation.db import CatalogDBObject, ObservationMetaData, Site
from lsst.sims.utils import altAzToRaDec, calcObsDefaults, getRotTelPos
